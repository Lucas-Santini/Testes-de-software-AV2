...
public class GooglePO extends BasePO {
	...
	/**
	 * PageFactory: injeta em tempo de execução (cria dinamicamente) uma logica de teste dentro 
	 * da classe de teste que instancia GooglePO, no nosso caso GoogleRefatorado2Test
